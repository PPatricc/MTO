...
.SILENT all:
	...
	$(call perform_test,uppercase,"Uppercase")
	$(call perform_test,lowercase,"Lowercase")
	$(call perform_test,bad,"Bad param")
	$(call perform_test,longer,"Longer argument than param")
	$(call restore_data)
